        ...
        if (hiddenNominees > 0) {
            ...
            buttonContainer.innerHTML = `
                <div class="col-12 text-center">
                    <button id="showMoreBtn" class="btn btn-outline-primary px-4 py-2" style="border: 2px solid var(--impact-primary); color: white; background: transparent; border-radius: 25px; transition: all 0.3s ease;">
