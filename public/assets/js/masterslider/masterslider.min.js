...
// Assurez-vous que le DOM est chargé avant d'interagir avec les éléments.
document.addEventListener("DOMContentLoaded", function () {
    // Création d'une instance de MasterSlider.
    var slider = new MasterSlider();

    // Ajout des contrôles de navigation flèches au slider.
    slider.control('arrows');
    slider.control('bullets');

    // Configuration du slider.
    slider.setup('masterslider', {
        width: 1400,     // Largeur standard du slider
        height: 810,     // Hauteur standard du slider
        space: 0,
        layout: 'fullwidth',
        loop: true,
        preload: 0,
