    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 text-center">
                <h2 class="h3 text-primary mb-3" data-aos="fade-up" data-aos-duration="1000">{{ __('reservation_form.header_subtitle1') }}</h2>
                <h3 class="h4 text-secondary mb-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">{{ __('reservation_form.header_subtitle2') }}</h3>
                
                <h4 class="h5 text-info mb-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">{{ __('reservation_form.header_subtitle3') }}</h4>
                
                <div class="reservation-options mx-auto" style="max-width: 600px;" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                    <p class="mb-2">{!! __('reservation_form.option_participant') !!}</p>
                    <p class="mb-2">{!! __('reservation_form.option_sponsor') !!}</p>
                    <p class="mb-0">{!! __('reservation_form.option_exhibitor') !!}</p>
                </div>
            </div>
        </div>
    </div>
