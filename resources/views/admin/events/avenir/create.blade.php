...
@section('title', "NOUVEAU ÉVÈNEMENT À VENIR")
@section('content')
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <h4 class="text-black">NOUVEAU ÉVÈNEMENT À VENIR</h4>
                        <h6 class="text-white p-3"><a class="btn bg-gradient-info" data-color="info" href="{{ route('admin.event-a-venir.index') }}">Voir la liste</a></h6>

                    </div>

                    <div class="card-body">
                    <!--- Formulaire --->
                    <form action="{{ route('admin.event-a-venir.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
