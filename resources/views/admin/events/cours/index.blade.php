...
@section('title', 'ÉVÈNEMENTS EN COURS')
@section('content')
            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="text-black p-3">ÉVÈNEMENTS EN COURS</h4>
                        <h6 class="text-white p-3"><a class="btn bg-gradient-info" data-color="info" href="{{ route('admin.event-en-cours.create') }}">Ajouter un évènements</a></h6>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle d-flex gap-2" style="position: relative; left:80px">
                                           <a href="{{ route('admin.event-en-cours.edit', $event) }}"><button class="btn btn-sm btn-danger">Modifier</button></a>
                                          <form action="{{ route('admin.event-en-cours.destroy', $event) }}" method="post">
                                            @csrf
                                              @method('delete')
