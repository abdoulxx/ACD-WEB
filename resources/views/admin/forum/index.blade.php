...
@section('title', 'TOUS LES INSCRIS POUR LE FORUM')
@section('content')
            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="text-black p-3">LISTE DES INSCRIS POUR LE FORUM </h4>
                        <h6 class="text-white p-3"><a class="btn bg-gradient-info" data-color="info" href="{{ route('admin.forum.create') }}">Ajouter un nouveau Inscris</a></h6>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <p>{{ $forum->numero_whatsapp }}</p>
                                        </td>

                                        <td class="align-middle text-center">
                                            <p>{{ $forum->entreprise }}</p>
                                        </td>
                                        <td class="align-middle text-center">
                                            <p>{{ $forum->statut }}</p>
                                        </td>
                                        ...
                                        <td class="align-middle text-center">
                                            <p>{{ \Carbon\Carbon::parse($forum->created_at)->isoFormat('Do MMMM YYYY [à] HH[h]mm') }}</p>
                                        </td>

                                        <td class="align-middle d-flex gap-2" style="position: relative; left:80px">
                                           <a href="{{ route('admin.forum.edit', $forum) }}"><button class="btn btn-sm btn-danger">Modifier</button></a>
